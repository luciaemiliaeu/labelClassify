...
chamadas = [("./databases/iris.csv", "EFD", [3,3,3,3], 10),("./databases/sementes.csv", "EFD", [3,3,3,3,3,3,3],5),("./databases/vidros.csv", "EWD", [4,4,4,4,4,4,4,4,4],15)]
...
for i in chamadas:
	...
	while per_tst < 1.0 :
		for j in range(10):
			...
			results.to_csv('./results/Resultado-'+str(i[0].split('.')[0])+'.csv', sep=',' )
		per_tst += 0.10
